...
export const MapSvgIcon = (props: SvgIconProps) => {
  return (
    <SvgIcon {...props} color="inherit">
      ...
      >
        <path
          d="M511.881,472.156L446.52,36.463c-0.809-5.329-5.383-9.227-10.777-9.227H76.257c-5.393,0-9.968,3.899-10.776,9.227
